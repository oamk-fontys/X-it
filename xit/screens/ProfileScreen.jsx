...
import VisitedRoomsTab from "../components/profile/VisitedRoomsTab";
...
export default function ProfileScreen() {
  ...
  const [routes] = useState([
    ...
    { key: 'stats', title: 'Visited Rooms', icon: 'bar-chart' },
  ]);
  ...
  const renderScene = SceneMap({
    overview: () => <OverviewTab userMock={userMock} user={user} />,
    stats: () => <VisitedRoomsTab />,
  });
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <TouchableOpacity onPress={openTokenModal} style={styles.tokenButton}>
        ...
        <Text style={styles.tokenButtonText}>Personal QR code</Text>
      </TouchableOpacity>
